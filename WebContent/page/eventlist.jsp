...
<html lang="en">
	...
	<body>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-lg-12">
	                <h1 class="page-header">이벤트 중인 푸드트럭보기
	                	<a href="foodtruck?cmd=AllFoodtruckList&page=1" class="btn btn-primary">전체 푸드트럭으로 돌아가기</a>
	                </h1>
	            </div>
	        </div>
	        <!-- /.row -->
	        ...
	        <div class="row text-center">
	            <div class="col-lg-12">
	                <ul class="pagination">
	                	...
	                	%>
	                    <li>
	                        <a href="foodtruck?cmd=AllEventFoodtruckList&page=1">&laquo;</a>
	                    </li>
	                    <%
	                 	...
	                 	%>
	                 		<li class="active">
	                        	<a href="foodtruck?cmd=AllEventFoodtruckList&page=<%=i%>"><%=i%></a>
	                    	</li>
	                 	<% 
	                 		} else {
	                 	%>
	                 	...
	                 	%>
	                    <li>
	                        <a href="foodtruck?cmd=AllEventFoodtruckList&page=<%=count/9+1%>">&raquo;</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
